...
#  password.
#  Default: ''
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$/+2zAQMxXQ+U8CwwONWzqw$sXlFBoAqkgd+xXj06pMHDF/liNcwE5WvsM7nSQyRYSY'
...
#  Choices: any of ['sha3_256', 'sha384', 'blake2b', 'sha3_384', 'sha1', 'md5', 'sha3_512', 'sha512', 'blake2s', 'sha256', 'sha3_224', 'sha224']
#  Default: 'sha256'
